...
Corollary type_theory_atlas_public_release_paper_route_entry_gives_stage2_mltt :
  forall gamma t a,
    has_type gamma t a ->
    supports MLTT t = true /\
    supports MLTT a = true.
...
Corollary type_theory_atlas_public_release_paper_route_entry_gives_stage3_utt :
  forall gamma t a,
    utt_has_type gamma t a ->
    supports UTT t = true /\
    supports UTT a = true.
...
Corollary type_theory_atlas_public_release_paper_route_entry_gives_stage4_tdtt_typing :
  forall theta gamma t a,
    tdtt_has_type theta gamma t a ->
    supports TDTT t = true /\
    supports TDTT a = true.
...
Corollary type_theory_atlas_public_release_paper_route_entry_gives_stage4_tdtt_dashboard :
  atlas_tdtt_regularity_dashboard.
Proof.
  exact (atlas_public_release_paper_route_stage4_tdtt_dashboard
    type_theory_atlas_public_release_paper_route_gives_certificate).
...
Corollary type_theory_atlas_public_release_paper_route_entry_gives_stage5_system_embeddings :
  atlas_system_embedding_regularities.
Proof.
  exact (atlas_public_release_paper_route_stage5_system_embeddings
    type_theory_atlas_public_release_paper_route_gives_certificate).
...
Corollary type_theory_atlas_public_release_paper_route_entry_gives_stage5_translation_reliability :
  atlas_translation_reliability_summary.
Proof.
  exact (atlas_public_release_paper_route_stage5_translation_reliability
    type_theory_atlas_public_release_paper_route_gives_certificate).
...
Corollary type_theory_atlas_public_release_paper_route_entry_gives_stage6_metatheory :
  type_theory_atlas_main_theorem.
Proof.
  exact (atlas_public_release_paper_route_stage6_metatheory
    type_theory_atlas_public_release_paper_route_gives_certificate).
...
Corollary type_theory_atlas_public_release_paper_route_entry_gives_paper_statement :
  type_theory_atlas_paper_statement.
Proof.
  exact (atlas_public_release_paper_route_paper_statement
    type_theory_atlas_public_release_paper_route_gives_certificate).
...
Record type_theory_atlas_public_release_citation_certificate : Prop := {
  atlas_public_release_citation_manifest :
    type_theory_atlas_public_release_manifest;
  atlas_public_release_citation_complete :
    type_theory_atlas_public_release_complete;
  atlas_public_release_citation_paper_route :
    type_theory_atlas_public_release_paper_route;
  atlas_public_release_citation_paper_route_certificate :
    type_theory_atlas_public_release_paper_route_certificate;
  atlas_public_release_citation_final_public_theorem :
    type_theory_atlas_final_public_theorem;
...
Theorem type_theory_atlas_public_release_citation_certificate_holds :
  type_theory_atlas_public_release_citation_certificate.
Proof.
  constructor.
  - apply type_theory_atlas_public_release_manifest_holds.
  - apply type_theory_atlas_public_release_paper_route_entry_gives_complete.
  - apply type_theory_atlas_public_release_paper_route_holds.
...
Corollary type_theory_atlas_public_release_citation_gives_manifest :
  type_theory_atlas_public_release_manifest.
Proof.
...
Corollary type_theory_atlas_public_release_citation_gives_complete :
  type_theory_atlas_public_release_complete.
Proof.
...
Corollary type_theory_atlas_public_release_citation_gives_paper_route :
  type_theory_atlas_public_release_paper_route.
Proof.
...
Corollary type_theory_atlas_public_release_citation_gives_paper_route_certificate :
  type_theory_atlas_public_release_paper_route_certificate.
Proof.
...
Corollary type_theory_atlas_public_release_citation_gives_final_public_theorem :
  type_theory_atlas_final_public_theorem.
Proof.
...
Corollary type_theory_atlas_public_release_citation_gives_final_certificate :
  type_theory_atlas_public_final_certificate.
Proof.
...
Corollary type_theory_atlas_public_release_citation_gives_paper_statement :
  type_theory_atlas_paper_statement.
Proof.
...
Record type_theory_atlas_public_release_acceptance_certificate : Prop := {
  atlas_public_release_acceptance_export_table :
    type_theory_atlas_public_release_export_table;
  atlas_public_release_acceptance_paper_ready_release :
    type_theory_atlas_public_release_paper_ready_release;
  atlas_public_release_acceptance_citation_certificate :
    type_theory_atlas_public_release_citation_certificate;
  atlas_public_release_acceptance_manifest :
    type_theory_atlas_public_release_manifest;
  atlas_public_release_acceptance_complete :
    type_theory_atlas_public_release_complete;
  atlas_public_release_acceptance_paper_route :
    type_theory_atlas_public_release_paper_route;
  atlas_public_release_acceptance_final_public_theorem :
    type_theory_atlas_final_public_theorem;
  atlas_public_release_acceptance_final_certificate :
    type_theory_atlas_public_final_certificate;
  atlas_public_release_acceptance_release_summary :
    type_theory_atlas_release_summary;
  atlas_public_release_acceptance_paper_statement :
    type_theory_atlas_paper_statement
}.

Theorem type_theory_atlas_public_release_acceptance_certificate_holds :
  type_theory_atlas_public_release_acceptance_certificate.
Proof.
  constructor.
  - apply type_theory_atlas_public_release_export_table_holds.
  - apply type_theory_atlas_public_release_export_table_gives_paper_ready_release.
  - apply type_theory_atlas_public_release_export_table_gives_citation_certificate.
  - apply type_theory_atlas_public_release_export_table_gives_manifest.
  - apply type_theory_atlas_public_release_export_table_gives_complete.
  - apply type_theory_atlas_public_release_export_table_gives_paper_route.
  - apply type_theory_atlas_public_release_export_table_gives_final_public_theorem.
  - apply type_theory_atlas_public_release_export_table_gives_final_certificate.
  - apply type_theory_atlas_public_release_export_table_gives_release_summary.
  - apply type_theory_atlas_public_release_export_table_gives_paper_statement.
Qed.

Corollary type_theory_atlas_public_release_acceptance_gives_export_table :
  type_theory_atlas_public_release_export_table.
Proof.
...
Corollary type_theory_atlas_public_release_acceptance_gives_paper_ready_release :
  type_theory_atlas_public_release_paper_ready_release.
Proof.
  exact (atlas_public_release_acceptance_paper_ready_release
    type_theory_atlas_public_release_acceptance_certificate_holds).
Qed.

Corollary type_theory_atlas_public_release_acceptance_gives_citation_certificate :
  type_theory_atlas_public_release_citation_certificate.
Proof.
  exact (atlas_public_release_acceptance_citation_certificate
    type_theory_atlas_public_release_acceptance_certificate_holds).
Qed.

Corollary type_theory_atlas_public_release_acceptance_gives_manifest :
  type_theory_atlas_public_release_manifest.
Proof.
...
Corollary type_theory_atlas_public_release_acceptance_gives_complete :
  type_theory_atlas_public_release_complete.
Proof.
...
Corollary type_theory_atlas_public_release_acceptance_gives_paper_route :
  type_theory_atlas_public_release_paper_route.
Proof.
...
Corollary type_theory_atlas_public_release_acceptance_gives_final_public_theorem :
  type_theory_atlas_final_public_theorem.
Proof.
  exact (atlas_public_release_acceptance_final_public_theorem
    type_theory_atlas_public_release_acceptance_certificate_holds).
Qed.

Corollary type_theory_atlas_public_release_acceptance_gives_final_certificate :
  type_theory_atlas_public_final_certificate.
Proof.
  exact (atlas_public_release_acceptance_final_certificate
    type_theory_atlas_public_release_acceptance_certificate_holds).
Qed.

Corollary type_theory_atlas_public_release_acceptance_gives_release_summary :
  type_theory_atlas_release_summary.
Proof.
  exact (atlas_public_release_acceptance_release_summary
    type_theory_atlas_public_release_acceptance_certificate_holds).
Qed.

Corollary type_theory_atlas_public_release_acceptance_gives_paper_statement :
  type_theory_atlas_paper_statement.
Proof.
...
Record type_theory_atlas_public_release_final_index : Prop := {
  atlas_public_release_final_index_one_click_entry :
    type_theory_atlas_public_release_one_click_entry;
  atlas_public_release_final_index_acceptance_certificate :
    type_theory_atlas_public_release_acceptance_certificate;
  atlas_public_release_final_index_export_table :
    type_theory_atlas_public_release_export_table;
  atlas_public_release_final_index_paper_ready_release :
    type_theory_atlas_public_release_paper_ready_release;
  atlas_public_release_final_index_citation_certificate :
    type_theory_atlas_public_release_citation_certificate;
  atlas_public_release_final_index_manifest :
    type_theory_atlas_public_release_manifest;
  atlas_public_release_final_index_complete :
    type_theory_atlas_public_release_complete;
  atlas_public_release_final_index_paper_route :
    type_theory_atlas_public_release_paper_route;
  atlas_public_release_final_index_final_public_theorem :
    type_theory_atlas_final_public_theorem;
  atlas_public_release_final_index_final_certificate :
    type_theory_atlas_public_final_certificate;
  atlas_public_release_final_index_release_summary :
    type_theory_atlas_release_summary;
  atlas_public_release_final_index_paper_statement :
    type_theory_atlas_paper_statement
}.

Theorem type_theory_atlas_public_release_final_index_holds :
  type_theory_atlas_public_release_final_index.
Proof.
  constructor.
  - apply type_theory_atlas_public_release_one_click_entry_holds.
  - apply type_theory_atlas_public_release_one_click_gives_acceptance_certificate.
  - apply type_theory_atlas_public_release_one_click_gives_export_table.
  - apply type_theory_atlas_public_release_acceptance_gives_paper_ready_release.
  - apply type_theory_atlas_public_release_acceptance_gives_citation_certificate.
  - apply type_theory_atlas_public_release_one_click_gives_manifest.
  - apply type_theory_atlas_public_release_one_click_gives_complete.
  - apply type_theory_atlas_public_release_one_click_gives_paper_route.
  - apply type_theory_atlas_public_release_acceptance_gives_final_public_theorem.
  - apply type_theory_atlas_public_release_acceptance_gives_final_certificate.
  - apply type_theory_atlas_public_release_acceptance_gives_release_summary.
  - apply type_theory_atlas_public_release_one_click_gives_paper_statement.
Qed.

Corollary type_theory_atlas_public_release_final_index_gives_one_click_entry :
  type_theory_atlas_public_release_one_click_entry.
Proof.
  exact (atlas_public_release_final_index_one_click_entry
    type_theory_atlas_public_release_final_index_holds).
Qed.

Corollary type_theory_atlas_public_release_final_index_gives_acceptance_certificate :
  type_theory_atlas_public_release_acceptance_certificate.
Proof.
  exact (atlas_public_release_final_index_acceptance_certificate
    type_theory_atlas_public_release_final_index_holds).
Qed.

Corollary type_theory_atlas_public_release_final_index_gives_export_table :
  type_theory_atlas_public_release_export_table.
Proof.
  exact (atlas_public_release_final_index_export_table
    type_theory_atlas_public_release_final_index_holds).
Qed.

Corollary type_theory_atlas_public_release_final_index_gives_paper_ready_release :
  type_theory_atlas_public_release_paper_ready_release.
Proof.
  exact (atlas_public_release_final_index_paper_ready_release
    type_theory_atlas_public_release_final_index_holds).
Qed.

Corollary type_theory_atlas_public_release_final_index_gives_citation_certificate :
  type_theory_atlas_public_release_citation_certificate.
Proof.
  exact (atlas_public_release_final_index_citation_certificate
    type_theory_atlas_public_release_final_index_holds).
Qed.

Corollary type_theory_atlas_public_release_final_index_gives_manifest :
  type_theory_atlas_public_release_manifest.
Proof.
  exact (atlas_public_release_final_index_manifest
    type_theory_atlas_public_release_final_index_holds).
Qed.

Corollary type_theory_atlas_public_release_final_index_gives_complete :
  type_theory_atlas_public_release_complete.
Proof.
  exact (atlas_public_release_final_index_complete
    type_theory_atlas_public_release_final_index_holds).
Qed.

Corollary type_theory_atlas_public_release_final_index_gives_paper_route :
  type_theory_atlas_public_release_paper_route.
Proof.
  exact (atlas_public_release_final_index_paper_route
    type_theory_atlas_public_release_final_index_holds).
Qed.

Corollary type_theory_atlas_public_release_final_index_gives_final_public_theorem :
  type_theory_atlas_final_public_theorem.
Proof.
  exact (atlas_public_release_final_index_final_public_theorem
    type_theory_atlas_public_release_final_index_holds).
Qed.

Corollary type_theory_atlas_public_release_final_index_gives_final_certificate :
  type_theory_atlas_public_final_certificate.
Proof.
  exact (atlas_public_release_final_index_final_certificate
    type_theory_atlas_public_release_final_index_holds).
Qed.

Corollary type_theory_atlas_public_release_final_index_gives_release_summary :
  type_theory_atlas_release_summary.
Proof.
  exact (atlas_public_release_final_index_release_summary
    type_theory_atlas_public_release_final_index_holds).
Qed.

Corollary type_theory_atlas_public_release_final_index_gives_paper_statement :
  type_theory_atlas_paper_statement.
Proof.
